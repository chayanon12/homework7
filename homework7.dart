...
class Test extends StatefulWidget {
  ...
  @override
  _GamePageBandR createState() => _GamePageBandR();
}

class _GamePageBandR extends State<Test> {
  var i = 0;
                  ...
                  children: [
                    ElevatedButton(
                      ...
                      style: ElevatedButton.styleFrom(
                          primary: Colors.red, fixedSize: Size(110, 50)),
                ...
                : Row(
                  ...
                  children: [
                    ElevatedButton(
                      onPressed: () {},
                      style: ElevatedButton.styleFrom(
                          primary: Colors.grey, fixedSize: Size(110, 50)),
                      child: Text('3', style: TextStyle(fontSize: 30.0)),
                    ),
                    ElevatedButton(
                      onPressed: () {},
                    ...
                    children: [
                      ...
                      Column(
                        children: [
                          ...
                          Text(i.toString(), style: TextStyle(fontSize: 150.0)),
                          !showNumber
                              ? Icon(
